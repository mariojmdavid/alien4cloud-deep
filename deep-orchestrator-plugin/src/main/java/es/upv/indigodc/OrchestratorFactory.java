...
public class OrchestratorFactory
    implements IOrchestratorPluginFactory<OrchestratorPlugin, CloudConfiguration> {
  ...
  @Override
  public void destroy(OrchestratorPlugin arg0) {
    arg0.destroy();
  }
  ...
  public CloudConfiguration getDefaultConfiguration() {
    ...
    InputStream is =
        OrchestratorFactory.class.getResourceAsStream(getCloudConfDefaultFile());
  ...
  public String getType() {
    return OrchestratorPlugin.TYPE;
  }

  @Override
  public OrchestratorPlugin newInstance() {
    return beanFactory.getBean(OrchestratorPlugin.class);
  }
}
