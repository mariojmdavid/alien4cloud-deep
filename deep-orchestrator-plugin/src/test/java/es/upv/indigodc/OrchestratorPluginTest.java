...
@Slf4j
public class OrchestratorPluginTest {
...
//		idco.init(new HashMap<String, PaaSTopologyDeploymentContext>());
//		TestUtil.setPrivateField(idco, "cloudConfigurationManager", cfm);
//		StatusManager statusManager = new StatusManager();
//		statusManager.init();
//		statusManager.addDeepDeploymentStatus(ALIEN_DEPLOYMENT_PAAS_ID, ALIEN_DEPLOYMENT_ID, ORCHESTRATOR_DEPLOYMENT_ID, ORCHESTRATOR_ID, 
//		    null, DeploymentStatus.DEPLOYED);
